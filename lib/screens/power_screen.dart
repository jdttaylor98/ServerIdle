...
class PowerScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final used = getTotalPowerDraw(game.servers);
    final total =
        getTotalCapacityAmount(game.capacity, 'power') +
        getBonusPowerCapacity(game.upgrades);
